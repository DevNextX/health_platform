...
class User(db.Model):
    ...
    password_hash = db.Column(db.String(256), nullable=True)  # Allow NULL for WeChat-only users
    wechat_openid = db.Column(db.String(128), unique=True, nullable=True)  # WeChat unique identifier
    age = db.Column(db.Integer)
