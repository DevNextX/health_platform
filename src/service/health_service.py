...
# Generated by Copilot: Helper function to normalize timestamp for API response (Issue #50)
def normalize_timestamp_for_response(ts):
    """Ensure timestamp is UTC and properly formatted with Z suffix"""
    if ts is None:
        return None
    # If timezone-naive (from SQLite), assume it's UTC
...
def create_record():
    ...
    # Generated by Copilot: Ensure timezone consistency for Issue #50
    if ts_raw:
    ...
    return jsonify({
        ...
        "timestamp": normalize_timestamp_for_response(rec.timestamp),
        "tags": tags,
        "note": rec.note,
        "created_at": normalize_timestamp_for_response(rec.created_at),
...
def list_records():
    ...
    data = [{
        ...
        "timestamp": normalize_timestamp_for_response(r.timestamp),
...
def export_csv():
    ...
    for r in items:
        ...
        writer.writerow([
            ...
            normalize_timestamp_for_response(r.timestamp),
            r.systolic,
            r.diastolic,
