...
def make_tokens(identity: str | int, token_version: int, additional_claims: dict | None = None,
                access_expires: timedelta | None = None, refresh_expires: timedelta | None = None) -> dict:
