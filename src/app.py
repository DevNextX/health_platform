...
from .service.super_admin_service import super_admin_bp
            ...
            if backend == "sqlite":
                ...
                if auto_env:
                    ...
                    try:
                        ...
                        required = {"users", "members", "health_records", "households", "record_subjects", "threshold_configs", "threshold_audit_logs"}
