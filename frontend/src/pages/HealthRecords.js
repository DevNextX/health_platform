...
const HealthRecords = () => {
  ...
  // Generated by Copilot: track form validation status for save button
  const [isFormValid, setIsFormValid] = useState(false);

  // Generated by Copilot: custom validator for systolic > diastolic
  const validateBloodPressureRelation = (_, value) => {
    ...
    if (systolic && diastolic && systolic <= diastolic) {
      return Promise.reject(new Error(t('validation.systolicGreaterThanDiastolic')));
    }
    return Promise.resolve();
  };

  // Generated by Copilot: monitor form validation status
  ...
  setEditingRecord(null);
    ...
    setIsFormValid(false); // Generated by Copilot: reset validation state
  ...
  const handleEdit = (record) => {
    ...
    setIsFormValid(true); // Generated by Copilot: assume existing record is valid
    setModalVisible(true);
  };
    ...
    title={editingRecord ? t('health.modal.editTitle') : t('health.modal.addTitle')}
      ...
      rules={[{ required: true, message: t('health.form.timestamp') }]}
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  ...
                  { type: 'number', min: 30, max: 250, message: t('validation.bloodPressureRange') },
          ...
          <Form.Item
            ...
            rules={[
              { type: 'number', min: 30, max: 150, message: t('validation.heartRateRange') }
            ]}
          >
            <InputNumber
