...
4. Fill out the form. Consider using the name `Health Platform Labs <your-github-account-name>` to ensure it is unique. Click Next.
...
2. Create your enterprise
    ...
    a. Enter the name of your enterprise and choose the GitHub organization to connect to. Consider naming the enterprise `Health Platform Enterprise <your-github-account-name>` to ensure uniqueness.
