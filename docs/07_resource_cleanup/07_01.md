...
1. Run the following verification commands:
    ...
    # List resources with the name "health" or "<your-env-name>" according to the naming used during the exercises
    az resource list --query "[?contains(name, 'health') || contains(name, '<your-env-name>')]" --output table
