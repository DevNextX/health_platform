...
3. Select `HealthPlatformOrgConfig` (or your custom configuration name).
...
1. Navigate to your organization.
2. Go to **Settings** → **Security** → **Advanced Security** → **Configurations**.
3. From the Apply Configuration section, select `HealthPlatformOrgConfig` (or your custom configuration name).
